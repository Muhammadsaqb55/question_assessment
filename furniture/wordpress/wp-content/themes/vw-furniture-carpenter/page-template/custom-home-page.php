...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_furniture_carpenter_slider_hide_show', false) == 1 || get_theme_mod( 'vw_furniture_carpenter_resp_slider_hide_show', false) == 1) { ?>

    <section id="slider">
      <?php if(get_theme_mod('vw_furniture_carpenter_slider_type', 'Default slider') == 'Default slider' ){ ?>
            ...
            <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <h1 class="wow bounceInUp delay-1000" data-wow-duration="3s"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
                  <p class="wow bounceInUp delay-1000" data-wow-duration="3s"><?php $vw_furniture_carpenter_excerpt = get_the_excerpt(); echo esc_html( vw_furniture_carpenter_string_limit_words( $vw_furniture_carpenter_excerpt, esc_attr(get_theme_mod('vw_furniture_carpenter_slider_excerpt_number','30')))); ?></p>
                  <?php if( get_theme_mod('vw_furniture_carpenter_slider_button_text','READ MORE') != ''){ ?>
                    <div class="more-btn wow bounceInUp delay-1000" data-wow-duration="3s">
      ...
      <div class="clearfix"></div>
        <?php } else if(get_theme_mod('vw_furniture_carpenter_slider_type', 'Advance slider') == 'Advance slider'){?>
          <?php echo do_shortcode(get_theme_mod('vw_furniture_carpenter_advance_slider_shortcode')); ?>
        <?php } ?>
    </section>
  ...
  <section id="contact-sec" class="wow rollIn delay-1000" data-wow-duration="3s">
    <div class="container">
      <div class="row">
  ...
  <section id="serv-section" class="wow slideInRight delay-1000" data-wow-duration="3s">
    <div class="container">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="serv-box">
              ...
              <div class="service-inner">
                ...
                <p><?php $vw_furniture_carpenter_excerpt = get_the_excerpt(); echo esc_html( vw_furniture_carpenter_string_limit_words( $vw_furniture_carpenter_excerpt, esc_attr(get_theme_mod('vw_furniture_carpenter_services_excerpt_number','30')))); ?></p>
              </div>
            </div>
          </div>
          <?php endwhile;
