...
/* Breadcrumb Begin */
function vw_furniture_carpenter_the_breadcrumb() {
	if (!is_home()) {
		echo '<a href="';
...
function vw_furniture_carpenter_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'vw-furniture-carpenter') {
		wp_redirect(admin_url('themes.php?page=vw_furniture_carpenter_guide'));
	}
}
endif;
...
function vw_furniture_carpenter_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=vw_furniture_carpenter_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-furniture-carpenter' ) .'</a></span>';
		echo '<span class="demo-btn"><a href="'. esc_url( 'https://www.vwthemes.net/vw-furniture-carpenter-pro/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'VIEW DEMO', 'vw-furniture-carpenter' ) .'</a></span>';
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/themes/carpenter-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-furniture-carpenter' ) .'</a></span>';
	echo '</div>';
}
...
function vw_furniture_carpenter_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Social Icon', 'vw-furniture-carpenter' ),
		'description'   => __( 'Appears on right side footer', 'vw-furniture-carpenter' ),
		'id'            => 'footer-icon',
...
function vw_furniture_carpenter_scripts() {
	...
	wp_enqueue_script( 'vw-furniture-carpenter-custom-scripts', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );

	if (get_theme_mod('vw_furniture_carpenter_animation', true) == true){
...
define('VW_FURNITURE_CARPENTER_FREE_THEME_DOC',__('https://preview.vwthemesdemo.com/docs/free-vw-furniture-carpenter/','vw-furniture-carpenter'));
...
define('VW_FURNITURE_CARPENTER_PRO_DOC',__('https://preview.vwthemesdemo.com/docs/vw-furniture-carpenter-pro/','vw-furniture-carpenter'));
...
function vw_furniture_carpenter_logo_title_hide_show(){
	if(get_theme_mod('vw_furniture_carpenter_logo_title_hide_show') == '1' ) {
		return true;
	}
	return false;
}

function vw_furniture_carpenter_tagline_hide_show(){
	if(get_theme_mod('vw_furniture_carpenter_tagline_hide_show',0) == '1' ) {
		return true;
	}
	return false;
}
...
//Active Callback
function vw_furniture_carpenter_default_slider(){
	if(get_theme_mod('vw_furniture_carpenter_slider_type', 'Default slider') == 'Default slider' ) {
		return true;
	}
	return false;
}

function vw_furniture_carpenter_advance_slider(){
	if(get_theme_mod('vw_furniture_carpenter_slider_type', 'Default slider') == 'Advance slider' ) {
		return true;
	}
	return false;
}

function vw_furniture_carpenter_blog_post_featured_image_dimension(){
	if(get_theme_mod('vw_furniture_carpenter_blog_post_featured_image_dimension') == 'custom' ) {
		return true;
	}
	return false;
}
