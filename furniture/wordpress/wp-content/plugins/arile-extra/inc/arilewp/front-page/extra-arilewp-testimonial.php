	     ...
	     <?php if($arilewp_testimonial_area_title != null || $arilewp_testimonial_area_des != null): ?>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php endif; ?>
						<div class="theme-separator-line-horrizontal-full wow animate fadeInUpBig <?php if($activate_theme == 'Business Street' || $activate_theme == 'Ariletech' || $activate_theme == 'Alberta' || $activate_theme == 'InnoPress' || $activate_theme == 'Agency Street' || 'Etowah' == $activate_theme) { echo 'theme-bg-light'; } ?>" data-wow-delay=".3s"></div>
					</div>
				</div>
			</div>
	    <?php endif; ?>
